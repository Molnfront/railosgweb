...
<!--	or ask your database distributor 																-->
	...
	-->
	<component base="/railo-context/Component.cfc" component-default-import="org.railo.cfml.*" data-member-default-access="public" dump-template="/railo-context/component-dump.cfm" local-search="true" trigger-data-member="false" use-cache-path="true" use-shadow="true"> 
	</component>
	...
	-->
	<regional locale="en_US" timeserver="pool.ntp.org" timezone="Europe/Stockholm" use-timeserver="true"/>
	
	<!--
		enable and disable debugging
	 -->
	<debugging debug="false" template="/railo-context/templates/debugging/debugging-neo.cfm"/>
